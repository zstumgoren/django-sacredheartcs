...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('contacts_activity', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('errors', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('file_name', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
            ('cc_id', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('insert_time', self.gf('django.db.models.fields.DateTimeField')()),
            ('run_finish_time', self.gf('django.db.models.fields.DateTimeField')()),
            ...
            ('transaction_count', self.gf('django.db.models.fields.IntegerField')()),
            ('activity_type', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('contacts', ['Activity'])

        # Adding field 'Contact.archived'
        db.add_column('contacts_contact', 'archived', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True), keep_default=False)

        # Adding field 'Contact.needs_update'
        db.add_column('contacts_contact', 'needs_update', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Activity'
        db.delete_table('contacts_activity')

        # Deleting field 'Contact.archived'
        db.delete_column('contacts_contact', 'archived')

        # Deleting field 'Contact.needs_update'
        db.delete_column('contacts_contact', 'needs_update')
    ...
    models = {
        'contacts.activity': {
            ...
            'file_name': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'}),
